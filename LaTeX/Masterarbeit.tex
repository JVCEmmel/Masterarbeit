...
\begin{document}
	...
	\begin{singlespace}
		...
		\end{center}
			...
			\vspace{2cm}
		\begin{flushright}
			{\large Mörfelden-Walldorf, den 05.05.2021}\\
			\vspace{0.5cm}
...
\begin{itemize}
	...
	\item Metzger, Simon: Automatisierte Aufbereitung archäologischer Grabungsfotos mittels Computer Vision [Vorläufiger Titel], Mainz (2021).
